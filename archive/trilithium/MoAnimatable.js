 ...
 *
 * SUMMARY:
 *  Provides the features required to make an object animate, when applied to a class
 *  any properties that you want animated must be enabled in the initializeAnimatablePropertiesCore
 *  method, those properties must also use the getPropertyValue/setPropertyValue instead of using
 *  a class variable for the property value.
 *
 ...
 */
	...
	getPropertyValue : function(propertyName) {
		/**
		 * SUMMARY:
		 *  Gets the value of a property previous set using setPropertyValue.
		 *
		 * PARAMS:
		 *  String propertyName:
	...
	setPropertyValue : function(propertyName, value) {
		 ...
		 *
		 *  For example, if this was a text property and it changed, you may need
		 *  to re-measure or re-render a textblock.
		 */
