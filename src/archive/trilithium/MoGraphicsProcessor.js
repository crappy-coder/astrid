...
// @PRIVATE 
{
	...
	rect : function(x, y, width, height) {
		this.moveTo(new MoPathMoveSegment(x, y));
		this.pathTo(new MoPathLineSegment(x + width, y));
		this.pathTo(new MoPathLineSegment(x + width, y + height));
		this.pathTo(new MoPathLineSegment(x, y + height));
	},

	line : function(x1, y1, x2, y2) {
		this.moveTo(new MoPathMoveSegment(x1, y1));
		this.pathTo(new MoPathLineSegment(x2, y2));
	},
	...
	processPathOp : function(op, opType) {
		...
		switch(opType)
		{
			...
			case MoGraphicsOp.CubicCurveTo:
				...
				break;
			case MoGraphicsOp.Rect:
				this.currentPath.rect(params[0], params[1], params[2], params[3]);
				break;
			case MoGraphicsOp.Line:
				this.currentPath.line(params[0], params[1], params[2], params[3]);
				break;
			case MoGraphicsOp.Text:
