...
In the above example, we create a drawable shape fill with the color red, then create an animation for that shape to animate it's alpha property from 1 to 0, for a duration of 1000ms (or 1 second).
